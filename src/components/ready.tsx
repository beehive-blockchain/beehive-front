    ...
    <>
      <section className=" flex flex-col justify-center items-center font-display bg-blancBleu dark:bg-black p-8">
        ...
        <h2 className="heading-2 text-center whitespace-pre">
          Ready To Start Your
          <span className="block text-bleu dark:text-white whitespace-pre"> Crypto Journey ?</span>
        </h2>
        <p className="paragraph mt-4 text-center">
          Join thousands of investors who have already discovered the potential of Beehive.
